Here is my first project from the dataCamp training program i had the opportunity to obtain a scholarship. So below are the instructions of the project
